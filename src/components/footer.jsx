                            ...
                            <div className="container_fluid px-3 text-center text-md-start ">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4 text-center">
                                        {/* Links */}
                                        <h6 className="text-uppercase fw-bold">اللينكات المهمة</h6>
                                        <hr
                                        ...
                                        <p>
                                            <NavLink to="/programing" className="text-white text-decoration-none">
                                                برامج التدريب
                                            </NavLink>
                                        </p>
                                        <p>
                                            <NavLink to="/article" className="text-white text-decoration-none">
                                                المقالات
                                            </NavLink>
                                        </p>
                                        <p>
                                    ...
                                    <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                                        {/* Links */}
                                        <h6 className="text-uppercase fw-bold">اتصل بنا</h6>
                                        <hr
                                            className="mb-4 mt-0 d-inline-block mx-auto"
                                            style={{
                                                width: 60,
